/**
 * 戦略適合とビジネス環境分析 データ構造
 * プロジェクトマネジメントにおける戦略的整合性とビジネス環境の理解を支援
 */
 ...
 * 企業環境要因（EEF）データ
 */
export const enterpriseEnvironmentalFactors: EnterpriseEnvironmentalFactor[] = [
  // 内部要因
  {
    id: 'org-culture',
    name: '組織文化と構造',
 ...
 * 組織プロセス資産（OPA）データ
 */
export const organizationalProcessAssets: OrganizationalProcessAsset[] = [
  {
    id: 'pm-methodology',
    name: 'プロジェクトマネジメント手法',
    type: 'processes',
 ...
 * 戦略分析フレームワーク
 */
export const analysisFrameworks: AnalysisFramework[] = [
  {
    id: 'swot',
    name: 'SWOT分析',
    acronym: 'SWOT',
 ...
 * 戦略適合性評価のクライテリア
 */
export const strategicAlignmentCriteria = {
  businessValue: {
    name: 'ビジネス価値',
