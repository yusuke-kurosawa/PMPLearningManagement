...
export const completeProcessGroups = [
  '立上げ',
  '計画', 
  '実行',
  '監視・コントロール',
...
export const processITTO = {
  ...
  'プロジェクト作業の指揮・マネジメント': {
    inputs: ['プロジェクトマネジメント計画書', '承認済み変更要求', '組織体の環境要因', '組織のプロセス資産'],
  ...
  '要求事項の収集': {
    ...
    tools: ['専門家の判断', 'データ収集', 'データ分析', '意思決定', 'データ表現', '対人関係とチームに関するスキル'],
    outputs: ['要求事項文書', '要求事項トレーサビリティ・マトリックス']
  },
  'スコープの定義': {
    inputs: ['プロジェクト憲章', 'プロジェクトマネジメント計画書', '要求事項文書', '組織のプロセス資産'],
    tools: ['専門家の判断', '代替案分析', '多基準意思決定分析', '対人関係とチームに関するスキル', 'プロダクト分析'],
  ...
  'アクティビティの順序設定': {
    inputs: ['プロジェクトマネジメント計画書', 'アクティビティ・リスト', 'アクティビティ属性', 'マイルストーン・リスト'],
    tools: ['プレシデンス・ダイアグラム法', '依存関係の決定と統合', 'リードとラグ', 'PMIS'],
    outputs: ['プロジェクト・スケジュール・ネットワーク図', 'プロジェクト文書更新版']
  },
  'アクティビティの所要期間見積り': {
    inputs: ['プロジェクトマネジメント計画書', 'アクティビティ・リスト', 'アクティビティ属性', '資源要求事項'],
    tools: ['専門家の判断', '類推見積り', 'パラメトリック見積り', '三点見積り', 'ボトムアップ見積り'],
    outputs: ['所要期間見積り', '見積りの根拠', 'プロジェクト文書更新版']
  },
  'スケジュールの作成': {
    inputs: ['プロジェクトマネジメント計画書', 'アクティビティ・リスト', 'アクティビティ属性', 'プロジェクト・スケジュール・ネットワーク図'],
    tools: ['スケジュール・ネットワーク分析', 'クリティカル・パス法', '資源最適化', 'データ分析', 'スケジュール短縮'],
    outputs: ['スケジュール・ベースライン', 'プロジェクト・スケジュール', 'スケジュール・データ', 'プロジェクト・カレンダー']
  },
  'スケジュールのコントロール': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト・スケジュール', '作業パフォーマンス・データ'],
  ...
  'コストの見積り': {
    ...
    tools: ['専門家の判断', '類推見積り', 'パラメトリック見積り', 'ボトムアップ見積り', '三点見積り'],
  ...
  'コストのコントロール': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト資金要求事項', '作業パフォーマンス・データ'],
  ...
  // 品質マネジメント
  '品質マネジメントの計画': {
    inputs: ['プロジェクト憲章', 'プロジェクトマネジメント計画書', 'プロジェクト文書', '組織体の環境要因'],
    tools: ['専門家の判断', 'データ収集', 'データ分析', '意思決定', 'データ表現', 'テストと検査の計画'],
  ...
  'アクティビティ資源の見積り': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '組織体の環境要因', '組織のプロセス資産'],
    tools: ['専門家の判断', 'ボトムアップ見積り', '類推見積り', 'パラメトリック見積り', 'データ分析'],
  ...
  'チームの育成': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '組織体の環境要因', '組織のプロセス資産'],
    tools: ['コロケーション', 'バーチャル・チーム', 'コミュニケーション技術', '対人関係とチームに関するスキル'],
    outputs: ['チーム・パフォーマンス評価', '変更要求', 'プロジェクトマネジメント計画書更新版']
  },
  'チームのマネジメント': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '作業パフォーマンス報告書', 'チーム・パフォーマンス評価'],
    tools: ['対人関係とチームに関するスキル', 'PMIS'],
    outputs: ['変更要求', 'プロジェクトマネジメント計画書更新版', 'プロジェクト文書更新版']
  },
  '資源のコントロール': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '作業パフォーマンス・データ', '合意書'],
  ...
  'コミュニケーション・マネジメントの計画': {
    inputs: ['プロジェクト憲章', 'プロジェクトマネジメント計画書', 'プロジェクト文書', '組織体の環境要因'],
    tools: ['専門家の判断', 'コミュニケーション要求事項分析', 'コミュニケーション技術', 'コミュニケーション・モデル'],
    outputs: ['コミュニケーション・マネジメント計画書', 'プロジェクトマネジメント計画書更新版']
  },
  'コミュニケーションのマネジメント': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '作業パフォーマンス報告書', '組織体の環境要因'],
    tools: ['コミュニケーション技術', 'コミュニケーション方法', 'コミュニケーション・スキル', 'PMIS', '報告'],
    outputs: ['プロジェクト・コミュニケーション', 'プロジェクトマネジメント計画書更新版', 'プロジェクト文書更新版']
  },
  'コミュニケーションの監視': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト・コミュニケーション', '作業パフォーマンス・データ'],
  ...
  'リスクの特定': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '合意書', '調達文書', '組織体の環境要因'],
    tools: ['専門家の判断', 'データ収集', 'データ分析', '対人関係とチームに関するスキル', 'プロンプト・リスト'],
    outputs: ['リスク登録簿', 'リスク報告書', 'プロジェクト文書更新版']
  },
  '定性的リスク分析': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '組織体の環境要因', '組織のプロセス資産'],
    tools: ['専門家の判断', 'データ収集', 'データ分析', '対人関係とチームに関するスキル', 'リスク分類'],
    outputs: ['プロジェクト文書更新版']
  },
  '定量的リスク分析': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '組織体の環境要因', '組織のプロセス資産'],
  ...
  'リスク対応の計画': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '組織体の環境要因', '組織のプロセス資産'],
    tools: ['専門家の判断', '対人関係とチームに関するスキル', '脅威への戦略', '好機への戦略', 'コンティンジェンシー対応戦略'],
    outputs: ['変更要求', 'プロジェクトマネジメント計画書更新版', 'プロジェクト文書更新版']
  },
  'リスク対応策の実行': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '組織のプロセス資産'],
  ...
  // 調達マネジメント
  '調達マネジメントの計画': {
    inputs: ['プロジェクト憲章', 'ビジネス文書', 'プロジェクトマネジメント計画書', 'プロジェクト文書'],
    tools: ['専門家の判断', '市場調査', '会議'],
    outputs: ['調達マネジメント計画書', '調達戦略', '入札文書', '調達作業範囲記述書']
  },
  '調達の実行': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '調達文書', '納入者の提案', '組織体の環境要因'],
    tools: ['専門家の判断', '広告', '入札説明会', 'データ分析', '対人関係とチームに関するスキル'],
    outputs: ['選定された納入者', '合意書', '変更要求', 'プロジェクトマネジメント計画書更新版']
  },
  '調達のコントロール': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '合意書', '調達文書', '承認済み変更要求'],
  ...
  'ステークホルダー・エンゲージメントのマネジメント': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '組織体の環境要因', '組織のプロセス資産'],
    tools: ['専門家の判断', 'コミュニケーション・スキル', '対人関係とチームに関するスキル', '基本規則', '会議'],
    outputs: ['変更要求', 'プロジェクトマネジメント計画書更新版', 'プロジェクト文書更新版']
  },
  'ステークホルダー・エンゲージメントの監視': {
    inputs: ['プロジェクトマネジメント計画書', 'プロジェクト文書', '作業パフォーマンス・データ', '組織体の環境要因'],
    tools: ['データ分析', '意思決定', 'データ表現', 'コミュニケーション・スキル', '対人関係とチームに関するスキル'],
    outputs: ['作業パフォーマンス情報', '変更要求', 'プロジェクトマネジメント計画書更新版']
  }
};
