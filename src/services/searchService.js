...
class SearchService {
    ...
    const learningFeatures = [
      {
        id: 'flashcards',
        title: 'フラッシュカード学習',
        content: 'ITTOを効率的に暗記する3Dアニメーション付きフラッシュカード。間隔反復学習アルゴリズムで記憶の定着をサポート。',
        url: '/flashcards'
      },
      {
        id: 'mock-exam',
        title: 'PMP模擬試験',
        content: '実際の試験形式で練習。180問・230分のフル模擬試験で、詳細な結果分析と弱点把握が可能。',
        url: '/mock-exam'
      },
      {
        id: 'progress',
      ...
      },
      {
        id: 'visualizations',
        title: 'ビジュアライゼーションハブ',
        content: 'サンキーダイアグラム、マインドマップ、ヒートマップなど8種類の高度な視覚化オプション。',
        url: '/visualizations'
      }
    ];
  ...
  search(query, options = {}) {
    const {
      types = ['process', 'itto', 'glossary', 'feature'],
      fuzzy = true,
      limit = 20
    } = options;
