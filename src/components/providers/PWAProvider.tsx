...
import { getInstallPromptManager, PWAInstallPromptManager, InstallPromptState } from '../../lib/pwa/installPrompt';
...
export const PWAProvider: React.FC<PWAProviderProps> = ({ 
  ...
  const [offlineQueue, setOfflineQueue] = useState<Array<{ data: any; endpoint: string; timestamp: number }>>([]);
