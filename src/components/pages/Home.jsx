...
import { Grid, Network, Layers, ArrowRight, BookOpen, Sparkles, TrendingUp, Brain, GraduationCap, Users } from 'lucide-react';
...
const Home = () => {
  const features = [
    ...
    {
      title: 'コラボレーション',
      description: '新機能！他の学習者と知識を共有。学習ノート、ディスカッション、学習グループで一緒に学習を進めましょう。',
      icon: Users,
      link: '/collaboration',
