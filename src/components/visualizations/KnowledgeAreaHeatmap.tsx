...
const KnowledgeAreaHeatmap = React.memo(() => {
  ...
  useEffect(() => {
    ...
    // カラースケール
    const colorScale = d3.scaleSequential().interpolator(d3.interpolateYlOrRd).domain([0, 5])
    ...
    const legendAxis = d3.axisBottom(legendScale).ticks(6).tickFormat(d3.format('d'))
