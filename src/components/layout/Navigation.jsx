...
import { Grid, Network, Layers, Home, Menu, X, BookOpen, Sparkles, TrendingUp, Brain, GraduationCap, Moon, Sun, Users, Database, ToggleLeft } from 'lucide-react';
...
const Navigation = () => {
  ...
  const navItems = [
    ...
    { path: '/pmbok-versions', label: 'PMBOK版', icon: ToggleLeft, isNew: true }
  ];
