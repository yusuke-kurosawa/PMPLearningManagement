            ...
            <div className='space-y-4'>
              ...
              <div>
                <label className='flex cursor-pointer items-center gap-3 rounded-lg bg-gray-50 p-4 transition-colors hover:bg-gray-100'>
                  ...
                  <span id='completion-help' className='sr-only'>
                    Mark this process as completed in your learning progress
                  </span>
                  <CheckCircle2
              ...
              <div>
                ...
                />
                <span id='understanding-help' className='sr-only'>
                  Slide to set your understanding level from 0 to 100 percent
                </span>
              ...
              <div>
                <label htmlFor='learning-notes' className='mb-2 block font-medium text-gray-900'>
                  学習メモ
                </label>
                <textarea
                  id='learning-notes'
                ...
                <span id='notes-help' className='sr-only'>
                  Write your understanding, key points, and questions about this process
                </span>
              </div>
            </div>
          </div>
