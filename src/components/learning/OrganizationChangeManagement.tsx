...
const OrganizationChangeManagement: React.FC<OrganizationChangeManagementProps> = ({ className = '' }) => {
  ...
  const completeAssessment = () => {
    ...
    const averageScore = Object.values(cultureAssessment).reduce((a, b) => a + b, 0) / Object.values(cultureAssessment).length;
  ...
  // ADKARステージコンポーネント
  const ADKARStageCard: React.FC<{ stage: ADKARStage; progress: number }> = ({ stage, progress }) => (
    <Card className="h-full">
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          <div>
            <span className="text-lg font-bold text-blue-600">{stage.name}</span>
            <span className="text-lg font-bold text-gray-800 ml-2">({stage.nameJa})</span>
          </div>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="pt-4">
          <label className="block text-sm font-medium mb-2">進捗設定:</label>
    ...
    return (
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            <h4 className="font-semibold mb-2">評価項目:</h4>
          ...
          <div>
            <label className="block text-sm font-medium mb-2">現在のスコア: {score}/5</label>
            ...
            <Progress value={score * 20} className="w-full mt-2" />
          </div>
        </CardContent>
      </Card>
    );
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
        ...
        <TabsContent value="adkar" className="space-y-6">
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center">
              <div className="text-center">
                ...
                <Progress value={calculateOverallAdkarProgress()} className="w-40 mt-2" />
              </div>
            </div>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold mb-3 text-green-600">成功要因</h4>
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="h-4 w-4 mt-0.5 text-green-500" />
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-red-600">よくある失敗</h4>
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <AlertTriangle className="h-4 w-4 mt-0.5 text-red-500" />
                  ...
                  <div className="border-t pt-4">
                    <div className="flex items-center justify-between text-lg font-bold">
                      ...
                      <span className="text-blue-600">
                        {(Object.values(cultureAssessment).reduce((a, b) => a + b, 0) / Object.values(cultureAssessment).length).toFixed(1)}/5.0
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <TabsContent value="brightline" className="space-y-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              組織変革を成功に導く5つの必須要素。
              PMI Brightline Initiativeによる変革成功の実践的フレームワークです。
            </p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <h4 className="font-semibold mb-3 text-blue-600">Phase 1: 基盤構築</h4>
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-green-600">Phase 2: 実行展開</h4>
                  <ul className="space-y-1 text-sm">
                    <li>• 能力構築プログラムの実施</li>
                    <li>• 積極的な関与の拡大</li>
                    <li>• 測定システムの構築</li>
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-purple-600">Phase 3: 定着化</h4>
                  <ul className="space-y-1 text-sm">
                    <li>• 継続的な監視と改善</li>
                    <li>• 成果の測定と報告</li>
                    <li>• 学習と知識の蓄積</li>
