...
const StrategicAlignmentToolkit: React.FC<StrategicAlignmentToolkitProps> = ({
  className = '',
}) => {
  ...
  const projectScenarios: ProjectScenario[] = [
    {
      ...
      title: 'デジタル変革プロジェクト',
      description:
        '全社的なDXを推進し、業務プロセスのデジタル化と新サービス創出を目指すプロジェクト',
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
          {categories.map((category) => (
            <Card key={category.key}>
              <CardHeader>
                <CardTitle className={`rounded-lg p-3 text-center ${category.color}`}>
              ...
              <CardContent>
                <div className='min-h-[200px] space-y-2'>
                  ...
                  {swotAnalysis[category.key].length === 0 && (
                    <p className='py-8 text-center text-gray-400'>項目を追加してください</p>
                  )}
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                  <div>
                    <h4 className='mb-3 font-semibold'>主要ステークホルダー</h4>
                  ...
                  <div>
                    <h4 className='mb-3 font-semibold'>主要な課題</h4>
                    ...
                    <div key={criteria.id}>
                      <div className='mb-2 flex items-center justify-between'>
                        ...
                        <Badge variant='secondary'>
                          重み: {(criteria.weight * 100).toFixed(0)}%
                        </Badge>
                      </div>
                      <div className='flex space-x-2'>
                        {[1, 2, 3, 4, 5].map((score) => (
                          <Button
                            key={score}
                            variant={
                              evaluationScores[criteria.id] === score ? 'default' : 'outline'
                            }
                            className='flex-1'
            ...
            {overallScore > 0 && (
              <Card>
                ...
                <CardContent>
                      ...
                      return (
                        <div key={criteria.id} className='flex items-center justify-between'>
                          ...
                          <div className='flex items-center space-x-2'>
                            ...
                            <Progress value={weightedScore} className='h-2 w-20' />
                          </div>
                        </div>
                      )
                    })}
                  ...
                  {/* 推奨アクション */}
                  <div className='mt-6'>
                    <h4 className='mb-3 font-semibold'>推奨アクション</h4>
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            ...
            >
              <CardContent className='p-6 text-center'>
                ...
                <h3 className='mb-2 text-lg font-semibold'>SWOT分析ツール</h3>
            ...
            >
              <CardContent className='p-6 text-center'>
                ...
                <h3 className='mb-2 text-lg font-semibold'>プロジェクト評価ツール</h3>
                <p className='text-sm text-gray-600'>
