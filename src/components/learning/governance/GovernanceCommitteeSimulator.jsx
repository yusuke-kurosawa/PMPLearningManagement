...
const GovernanceCommitteeSimulator = () => {
  ...
  const calculateQuorum = () => {
    ...
    const totalPossibleWeight = committeeMembers.reduce(
      (sum, member) => sum + member.votingWeight,
      0
    )
            ...
            <TabsContent value='setup' className='space-y-6'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>ガバナンス委員会のメンバーと権限を設定</CardDescription>
                </CardHeader>
                <CardContent className='space-y-4'>
                  <div className='grid gap-4'>
                    {committeeMembers.map((member) => (
                      <Card
                        key={member.id}
                        className={`border-2 ${member.present ? 'border-green-200 bg-green-50' : 'border-gray-200'}`}
                      >
                        <CardContent className='p-4'>
                          ...
                          <div className='mt-3'>
                            <div className='mb-1 text-xs text-gray-600'>専門分野:</div>
              ...
              {!meetingInProgress ? (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>シミュレーションする意思決定シナリオを選択</CardDescription>
                  </CardHeader>
                  <CardContent className='space-y-4'>
                          ...
                          <CardContent className='p-4'>
                            <div className='mb-3 flex items-start justify-between'>
                              <div className='flex-1'>
                                <h3 className='mb-1 font-medium text-gray-900'>{template.title}</h3>
                ...
                <Card>
                  ...
                  <CardContent className='space-y-6'>
                    ...
                    <div className='grid gap-4 md:grid-cols-2'>
                      <div>
                        <h3 className='mb-3 font-medium text-gray-900'>出席者</h3>
                      ...
                      <div>
                        <h3 className='mb-3 font-medium text-gray-900'>決定事項</h3>
                        <div className='space-y-2'>
                          <p className='text-sm text-gray-600'>{currentMeeting.description}</p>
                          <div>
                            <div className='mb-1 text-xs text-gray-600'>選択肢:</div>
                      ...
                      <div className='space-y-4'>
                            ...
                            <div className='flex gap-2'>
                              {currentMeeting.options.map((option) => (
                                <Button
                                  ...
                                  variant={
                                    votingResults[member.id] === option ? 'default' : 'outline'
                                  }
                                  size='sm'
                                >
                                  {option}
                        ...
                        <div className='flex justify-center gap-4'>
                          <Button
                            ...
                            disabled={
                              Object.keys(votingResults).length < currentMeeting.attendees.length
                            }
                          >
                    ...
                    {currentMeeting.phase === 'completed' && (
                      <div className='space-y-4'>
                        ...
                        <div>
                          <h3 className='mb-3 font-medium text-gray-900'>投票結果詳細</h3>
                          <div className='space-y-2'>
            ...
            <TabsContent value='decisions' className='space-y-6'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>過去の委員会決定とその結果</CardDescription>
                </CardHeader>
                <CardContent>
                  {decisions.length === 0 ? (
                        ...
                        <Card key={decision.id} className='border-2 border-gray-200'>
                          <CardContent className='p-4'>
                            ...
                            <div className='grid gap-3 md:grid-cols-2'>
                              <div>
                                <div className='mb-1 text-xs text-gray-600'>最終決定:</div>
                                <div className='font-medium'>{decision.finalDecision}</div>
                              </div>
                              <div>
                                <div className='mb-1 text-xs text-gray-600'>決定日時:</div>
                            ...
                            <div className='mt-3'>
                              <div className='mb-2 text-xs text-gray-600'>投票結果:</div>
            ...
            <TabsContent value='analytics' className='space-y-6'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>委員会の意思決定効率と傾向の分析</CardDescription>
                </CardHeader>
                <CardContent className='space-y-6'>
                  <div className='grid gap-6 lg:grid-cols-2'>
                    <div>
                      <h3 className='mb-4 font-medium text-gray-900'>月次活動履歴</h3>
                    ...
                    <div>
                      <h3 className='mb-4 font-medium text-gray-900'>決定結果分布</h3>
                      <ResponsiveContainer width='100%' height={300}>
                        <RechartsPieChart>
                          <Pie
