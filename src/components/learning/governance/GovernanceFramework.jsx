...
const GovernanceFramework = () => {
  ...
  const templates = {
    software: {
      ...
      strength: 30,
      components: ['structure', 'processes', 'decisions', 'management', 'reporting', 'transparency', 'accountability', 'risk', 'quality', 'value', 'stakeholder'],
    ...
    infrastructure: {
      ...
      strength: 80,
      components: ['structure', 'processes', 'decisions', 'oversight', 'management', 'control', 'reporting', 'transparency', 'accountability', 'risk', 'quality', 'value', 'stakeholder'],
    ...
    compliance: {
      ...
      strength: 90,
      components: ['structure', 'processes', 'decisions', 'oversight', 'management', 'control', 'reporting', 'transparency', 'accountability', 'risk', 'quality'],
  ...
  const getStrengthLabel = (strength) => {
    if (strength < 33) return '軽量（Light）'
    if (strength < 67) return '中程度（Medium）'
    return '重厚（Heavy）'
  }

  const getStrengthColor = (strength) => {
    if (strength < 33) return 'text-green-600'
    if (strength < 67) return 'text-yellow-600'
    return 'text-red-600'
  }
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-lg bg-green-50 p-4">
                <div className="text-2xl font-bold text-green-700">
                  {Array.from(selectedComponents).filter(id => 
                    governanceComponents.find(c => c.id === id)?.required
                  ).length}
                </div>
            ...
            <Alert>
              ...
              <AlertDescription>
                このフレームワークは{getStrengthLabel(governanceStrength[0])}レベルのガバナンスを提供し、
