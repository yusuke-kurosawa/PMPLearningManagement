...
const QuestionItem = memo<{
  ...
  return (
    <div className='mb-4 rounded-lg bg-white p-6 shadow-md transition-all duration-200'>
      <div className='mb-4 flex items-start justify-between'>
        <div className='flex-1'>
          ...
          <h3 className='whitespace-pre-wrap text-lg font-medium text-gray-900'>
            {question.question}
          </h3>
        </div>
        <button
...
const OptimizedMockExam: React.FC = () => {
  ...
  const submitExam = useCallback(() => {
    ...
    const results = analyzeExamResults(examQuestions, Array.from(answers.values()))
      ...
      <div className='min-h-screen bg-gray-50 py-8'>
        <div className='mx-auto max-w-3xl px-4'>
          <div className='rounded-lg bg-white p-8 shadow-lg'>
            <h1 className='mb-6 text-3xl font-bold text-gray-900'>PMP Mock Exam</h1>
            <div className='space-y-4'>
              <div className='rounded-lg bg-blue-50 p-4'>
                <h3 className='mb-2 font-semibold text-blue-900'>Exam Details</h3>
