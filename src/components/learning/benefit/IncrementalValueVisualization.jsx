...
const IncrementalValueVisualization = () => {
  ...
  const timelineData = useMemo(() => {
    ...
    let waterfallDelay = Math.ceil(sprints * 0.6) // ウォーターフォールは60%遅延
    ...
    return data
  }, [sprintCount, sprintDuration, valuePerSprint, selectedScenario, customSprintValues, feedbackImpact])
  ...
  const mvpMilestones = useMemo(() => {
    ...
    return [
      ...
      { sprint: Math.ceil(sprints * 0.4), name: 'MVP Beta', value: 50, description: 'コア機能統合' },
      { sprint: Math.ceil(sprints * 0.7), name: 'MVP Release', value: 80, description: '市場投入準備' },
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">フィードバック効果: {feedbackImpact[0]}%</label>
                <Slider
                ...
                <div className="h-96">
                  <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={timelineData}>
                      ...
                      />
                      <YAxis 
                        label={{ value: '累積価値', angle: -90, position: 'insideLeft' }}
                      />
                      ...
                      <CardContent className="pt-6">
                        <div className="mb-2">
                          <div className={`mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-full ${
                            milestone.sprint <= sprintCount[0] ? 'bg-green-500 text-white' : 'bg-gray-300 text-gray-600'
                          }`}>
                        ...
                        <Badge variant={milestone.sprint <= sprintCount[0] ? "default" : "secondary"}>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        <th className="text-left p-2">アプローチ</th>
                        <th className="text-left p-2">ROI (%)</th>
                        <th className="text-left p-2">価値実現開始</th>
                        <th className="text-left p-2">リスク</th>
                        <th className="text-left p-2">柔軟性</th>
                        <th className="text-left p-2">総価値</th>
                      </tr>
                    </thead>
                    <tbody>
          ...
          <TabsContent value="mvp" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Minimum Viable Productの段階的な価値向上
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-96">
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {[
                    { phase: 'Alpha', features: ['基本ユーザー登録', 'コア機能', 'シンプルUI'], value: 25 },
                    { phase: 'Beta', features: ['統合テスト完了', 'パフォーマンス最適化', 'フィードバック収集'], value: 60 },
                    { phase: 'Release', features: ['本番環境準備', 'ドキュメント完備', '運用監視'], value: 100 },
                  ].map((mvp, index) => (
                    <Card key={index} className="text-center">
                      <CardHeader>
                      ...
                      <CardContent>
                        <div className="mb-4">
                          <div className="mx-auto mb-2 h-16 w-16 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white text-lg font-bold">
                            {mvp.value}%
                          </div>
                        </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-green-600 mb-2">+{feedbackImpact[0]}%</div>
          ...
          <TabsContent value="roi" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  漸進型開発による財務的メリットの詳細分析
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div>
                    <h3 className="text-lg font-semibold mb-4">累積ROI推移</h3>
                    <div className="h-64">
                      <ResponsiveContainer width="100%" height="100%">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-4">価値実現速度</h3>
                    <div className="space-y-4">
                      <div className="p-4 bg-green-50 rounded-lg">
                        <div className="flex justify-between items-center">
                          <span className="font-medium">アジャイル</span>
                          <span className="text-green-600 font-bold">
                            {(timelineData[Math.ceil(timelineData.length / 2)]?.cumulativeAgile || 0).toFixed(1)}
                          </span>
                        </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div>
                    <h4 className="font-semibold mb-3">アジャイル開発のメリット</h4>
                  ...
                  <div>
                    <h4 className="font-semibold mb-3">価値実現の要因</h4>
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2 text-sm">
