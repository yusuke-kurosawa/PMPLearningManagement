        ...
        <div className="mb-8 text-center">
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-sm text-gray-500">
              学習進捗: {Math.round(learningProgress)}% ({completedSections.size}/{learningModules.length} モジュール完了)
            </p>
          </div>
        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className={`flex h-8 w-8 items-center justify-center rounded-full ${
                            isCompleted(module.id) ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-600'
                          }`}>
                            {isCompleted(module.id) ? <CheckCircle2 className="h-4 w-4" /> : index + 1}
                          </div>
                          <div>
                  ...
                  {valueTypes.map((valueType) => {
                    ...
                    return (
                      <Card
                        ...
                        onClick={() => setSelectedValueType(
                          selectedValueType === valueType.id ? null : valueType.id
                        )}
                      >
                        <CardHeader>
                          <div className="flex items-center gap-3">
                            <div className={`flex h-10 w-10 items-center justify-center rounded-lg ${valueType.color} text-white`}>
                        ...
                        <CardContent>
                          <div className="space-y-3">
                            <div>
                              <h4 className="text-sm font-medium text-gray-700 mb-2">主要指標</h4>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                          {step.actions.map((action, actionIndex) => (
                            <div key={actionIndex} className="flex items-center gap-2 text-sm text-gray-600 bg-gray-50 p-2 rounded">
              ...
              <CardContent>
                <div className="space-y-6">
                  <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">必須構成要素</h3>
                      <div className="space-y-3">
                        {[
                          '問題の定義と背景',
                          '提案するソリューション',
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">財務指標の計算</h3>
                      <div className="space-y-4">
                        <div className="p-4 bg-green-50 rounded-lg">
                          <h4 className="font-medium text-green-900">ROI (投資収益率)</h4>
                          <p className="text-sm text-green-700">ROI = (利益 - 投資額) / 投資額 × 100</p>
                        </div>
                        <div className="p-4 bg-purple-50 rounded-lg">
                          <h4 className="font-medium text-purple-900">NPV (正味現在価値)</h4>
                          <p className="text-sm text-purple-700">将来のキャッシュフローを現在価値に割引</p>
                        </div>
              ...
              <CardContent>
                ...
                <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-sm text-blue-700">アジャイル vs ウォーターフォールの価値実現パターン比較</p>
                  </div>
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <BarChart3 className="h-8 w-8 text-green-600 mx-auto mb-2" />
                    <h3 className="font-semibold text-green-900">ROI分析</h3>
                    <p className="text-sm text-green-700">投資対効果の詳細な財務分析とシミュレーション</p>
                  </div>
