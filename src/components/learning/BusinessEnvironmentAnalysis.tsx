...
const BusinessEnvironmentAnalysis: React.FC<BusinessEnvironmentAnalysisProps> = ({
  className = '',
}) => {
  ...
  const practiceQuestions = [
    {
      id: 'q1',
      scenario:
        'あなたのプロジェクトチームは、新しい製品開発プロジェクトを開始しようとしています。しかし、組織には類似のプロジェクト経験が少なく、業界の技術標準も急速に変化しています。',
      question: 'この状況で最も重要なEEF（企業環境要因）は何ですか？',
      options: ['組織文化と構造', '技術動向', 'リソースの可用性', '規制・法的環境'],
      correct: 1,
      explanation:
        '急速に変化する技術標準は外部の技術動向として分類され、プロジェクトの技術選択や実装方法に大きな影響を与えるため、最も重要なEEFです。',
    },
    {
      id: 'q2',
      scenario:
        'ITシステム更新プロジェクトで、社内には過去5年間の類似プロジェクトの詳細な記録と、失敗・成功要因の分析結果があります。',
      ...
      correct: 1,
      explanation:
        '過去のプロジェクト記録と分析結果は、組織の知識とナレッジベースに分類される貴重なOPAです。これらの情報は今後のプロジェクト計画に活用できます。',
    },
    {
      id: 'q3',
      scenario:
        '国際的なプロジェクトで、複数の国の法規制に準拠する必要があり、各国の政治情勢も不安定な状況です。',
      question: 'この場合、プロジェクトマネージャーが最も注意すべきEEFのカテゴリーは？',
      options: ['内部要因', '外部要因', 'どちらも同程度', '判断できない'],
      correct: 1,
      explanation:
        '国際的な法規制と政治情勢は組織外部の環境要因であり、プロジェクトマネージャーが直接制御できない外部要因として管理する必要があります。',
    },
    {
      id: 'q4',
      scenario:
        'プロジェクト開始時に、組織の標準的なプロジェクト憲章テンプレートと承認プロセスを使用することになりました。',
      ...
      correct: 0,
      explanation:
        'プロジェクト憲章テンプレートは「テンプレートとフォーム」、承認プロセスは「プロセスとガイドライン」に分類される複合的なOPAです。',
    },
    {
      id: 'q5',
      scenario:
        '組織のリスク許容度が非常に低く、すべてのプロジェクト決定に複数レベルの承認が必要です。',
      ...
      correct: 1,
      explanation:
        '組織のリスク許容度の低さと多重承認システムは、ステークホルダーのリスク許容度というEEFに直接関連し、プロジェクト運営方法に影響します。',
    },
  ]
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            <div className='flex items-center space-x-2'>
              ...
              <span className='text-sm'>
                <strong>責任者:</strong> {opa.owner}
              </span>
            </div>
            <div className='flex items-center space-x-2'>
              <AlertTriangle className='h-4 w-4 text-gray-500' />
              <span className='text-sm'>
                <strong>更新頻度:</strong> {opa.updateFrequency}
              </span>
            </div>
          </div>
        </CardContent>
                  ...
                  <CardContent className='p-6'>
                    ...
                    <div className='flex space-x-2'>
                      <Badge variant='default'>
                        内部要因:{' '}
                        {
                          enterpriseEnvironmentalFactors.filter((e) => e.category === 'internal')
                            .length
                        }
                        個
                      </Badge>
                      <Badge variant='secondary'>
                        外部要因:{' '}
                        {
                          enterpriseEnvironmentalFactors.filter((e) => e.category === 'external')
                            .length
                        }
                        個
                      </Badge>
                        ...
                        <CardContent className='p-4'>
                          <div className='flex items-start space-x-3'>
                            ...
                            <div className='flex-1'>
                              <h4 className='text-sm font-semibold'>{eef.name}</h4>
                              <p className='mt-1 text-xs text-gray-600'>{eef.description}</p>
                        ...
                        <CardContent className='p-4'>
                          <div className='flex items-start space-x-3'>
                            ...
                            <div className='flex-1'>
                              ...
                              <p className='mt-1 text-sm text-gray-600'>{opa.description}</p>
