...
export function MobileProgressDashboard({ 
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-900">
      ...
      {isPulling && (
        <div 
          className="fixed top-0 left-1/2 transform -translate-x-1/2 z-50 transition-transform"
        ...
        <div className="flex px-4">
          {[
            ...
            <button
              ...
              className={`
                flex-1 flex items-center justify-center space-x-2 py-4 border-b-2 transition-colors
                ${activeTab === tab.key
      ...
      <div className="flex-1 overflow-y-auto">
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span>{stats.weeklyProgress}h / {stats.weeklyGoal}h</span>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  {recentAchievements.map(achievement => (
                    <div 
                      key={achievement.id}
                      className="flex items-center space-x-3 p-2 rounded-lg bg-yellow-50 dark:bg-yellow-900/20"
                    >
        ...
        {activeTab === 'achievements' && (
          <div className="p-4 space-y-4">
            ...
            <div>
              <h3 className="font-medium mb-3">獲得した実績</h3>
            ...
            {inProgressAchievements.length > 0 && (
              <div>
                <h3 className="font-medium mb-3">進行中の実績</h3>
                <div className="space-y-3">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{stats.completedProcesses} / {stats.totalProcesses}</span>
                </div>
                <div className="flex justify-between">
