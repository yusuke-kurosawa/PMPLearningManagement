          ...
          >
            ...
            <div className="flex items-start justify-between mb-2">
              ...
              <button
                ...
                className={`flex items-center gap-1 text-sm px-2 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${
                  comment.likes > 0 ? 'text-red-500' : ''
                }`}
              >
                <Heart className={`w-3 h-3 ${comment.likes > 0 ? 'fill-current' : ''}`} />
