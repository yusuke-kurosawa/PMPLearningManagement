  ...
  },
  {
    ...
    fixes: [
      ...
      },
      {
        ...
        replace: 'export function virtualScroll(items: any[], containerHeight: number, itemHeight: number, scrollTop: number) {'
      },
      {
    ...
    fixes: [
      {
        ...
        replace: 'export function getProcessName(knowledgeAreaId: number, processGroup: string, processIndex: number): string {'
      },
      {
