...
const RECOMMENDED_LABELS = [
  // TYPE: イシューの種類
  { name: "🐛 バグハンター", color: "d73a4a", description: "バグを退治して、学習体験をより良くしよう！勇敢なハンターを募集中" },
  { name: "✨ アイデアマジシャン", color: "a2eeef", description: "新機能のアイデアを魔法のように実現！クリエイティブな提案を歓迎" },
  { name: "🚀 スピードスター", color: "0075ca", description: "既存機能の改善でパフォーマンスアップ！より速く、より使いやすく" },
  { name: "📚 知識の伝道師", color: "7057ff", description: "学習コンテンツの充実！PMBOK情報や教材の改善提案" },
  { name: "📄 ドキュメントの芸術家", color: "0e8a16", description: "わかりやすい説明文を作成！新しい学習者の道しるべ" },
  { name: "❓ サポートヒーロー", color: "d876e3", description: "質問・サポート対応！みんなで助け合って成長しよう" },

  // PRIORITY: 優先度
  { name: "🚨 優先度:緊急", color: "b60205", description: "本番停止・重大な機能障害！すぐに対応が必要" },
  { name: "🔥 優先度:高い", color: "d93f0b", description: "ユーザー体験に大きく影響！優先的に取り組むべき課題" },
  { name: "📋 優先度:中", color: "fbca04", description: "バランスの取れた重要度！計画的に取り組んで着実に前進" },
  { name: "🌱 優先度:低い", color: "0e8a16", description: "時間があるときにじっくりと！リラックスして取り組める改善" },

  // AREA: 機能エリア
  { name: "📊 視覚化機能", color: "006b75", description: "PMBOK図表・グラフ・ネットワーク表示の改善" },
  { name: "🎓 学習機能", color: "1d76db", description: "フラッシュカード・模擬試験・進捗管理" },
  { name: "📱 モバイル対応", color: "0366d6", description: "スマホ・タブレット・PWA・タッチ操作の改善" },
  { name: "🎨 UI/UX", color: "f9d0c4", description: "デザイン・操作性・ユーザビリティの向上" },
  { name: "⚡ パフォーマンス", color: "ffd33d", description: "速度・レスポンス・メモリ使用量の最適化" },
  { name: "🔐 セキュリティ", color: "d1f2a5", description: "認証・認可・データ保護・セキュリティ対策" },

  // STATUS: 作業状況
  { name: "🔍 調査フェーズ：謎解き中", color: "ededed", description: "情報収集と分析の段階！問題の本質を探る探偵のような作業" },
  { name: "⚡ 開発中：クリエイティブタイム", color: "c5def5", description: "コーディングに集中中！創造力を発揮してアイデアを形にしよう" },
  { name: "👀 レビュー待ち：最終チェック", color: "f9c513", description: "品質確認の段階！みんなでコードを見て、さらに良くしよう" },

  // LEVEL: 難易度
  { name: "🌟 レベル1：初心者への贈り物", color: "bfdbfe", description: "プログラミング初心者も歓迎！優しく学べる最初の一歩" },
  { name: "⭐ レベル2：駆け出し冒険者", color: "93c5fd", description: "基礎を身につけた君に！少しチャレンジングだけど楽しめる" },
  { name: "🔥 レベル3：熟練者の挑戦", color: "3b82f6", description: "スキルを試す本格チャレンジ！経験豊富な開発者向け" },

  // COMMUNITY: コミュニティ
  { name: "🌟 みんなで挑戦：チーム・クエスト", color: "84cc16", description: "複数人でのコラボレーション歓迎！知識を共有し、一緒に成長" },
  { name: "🎓 メンター募集：教えて先輩", color: "f97316", description: "経験豊富な開発者の知恵を借りたい！アドバイスとサポートを募集" },
  { name: "💡 アイデア・インキュベーター", color: "8b5cf6", description: "将来への投資！長期的な視点で考える革新的なアイデアや実験" },

  // SPECIAL: 特別な状況
  { name: "🚫 今回は見送り：将来への期待", color: "6b7280", description: "素晴らしいアイデアだけど今はタイミングではない！将来実現するかも" },
  { name: "🔄 重複問題：すでに議論済み", color: "9ca3af", description: "似たような話題を発見！過去の議論を参考に効率的に解決しよう" }
];
...
function updateExistingLabels(currentLabels) {
  ...
  RECOMMENDED_LABELS.forEach(newLabel => {
    ...
    if (existing && (existing.color !== newLabel.color || existing.description !== newLabel.description)) {
      try {
        execSync(
...
`;
  ...
  fs.writeFileSync(
    path.join(process.cwd(), '.github', 'ISSUE_TEMPLATE_GUIDE.md'),
    guide,
    'utf8'
  );
