...
describe('Auth Providers', () => {
  ...
  describe('Google Provider', () => {
    test('should be configured correctly', () => {
      const googleProvider = mockAuthConfig.providers!.find((p: any) => p.id === 'google') as any
  ...
  describe('GitHub Provider', () => {
    test('should be configured correctly', () => {
      const githubProvider = mockAuthConfig.providers!.find((p: any) => p.id === 'github') as any
