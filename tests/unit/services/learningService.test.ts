...
import {
  ...
  createStudySession,
  createExamResult,
} from '../../factories/progressFactory'
...
describe('LearningService', () => {
  ...
  describe('LearningStatsCalculator', () => {
    ...
    describe('calculateKnowledgeAreaStats', () => {
      test('should calculate knowledge area statistics', () => {
        ...
        const stats = LearningStatsCalculator.calculateKnowledgeAreaStats(sessions, examResults)
      ...
      test('should handle missing knowledge area scores', () => {
        const sessions = [createStudySession({ knowledgeArea: 'Integration', completed: true })]

        const examResults = [createExamResult({ knowledgeAreaScores: null })]
    ...
    describe('calculateProcessGroupStats', () => {
      test('should calculate process group statistics', () => {
        ...
        const stats = LearningStatsCalculator.calculateProcessGroupStats(sessions, examResults)
  ...
  describe('getLearningProgress', () => {
    ...
    test('should handle database errors', async () => {
      ...
      await expect(LearningService.getLearningProgress('user-123')).rejects.toThrow(TRPCError)
    })
  })
  ...
  describe('recordStudySession', () => {
    ...
    test('should handle missing progress record', async () => {
      ...
      await expect(LearningService.recordStudySession(userId, sessionData)).rejects.toThrow(
