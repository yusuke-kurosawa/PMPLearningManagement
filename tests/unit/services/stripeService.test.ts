...
describe('StripeService', () => {
  ...
  describe('getCustomer', () => {
    ...
    test('should handle other Stripe errors', async () => {
      mockStripe.customers.retrieve.mockRejectedValue(new Error('Network error'))
  ...
  describe('cancelSubscription', () => {
    ...
    test('should handle cancellation errors', async () => {
      mockStripe.subscriptions.update.mockRejectedValue(new Error('Subscription not found'))

      await expect(stripeService.cancelSubscription('sub_invalid')).rejects.toThrow(
        expect.objectContaining({
          code: 'INTERNAL_SERVER_ERROR',
          message: 'Failed to cancel subscription',
        })
  ...
  describe('createCheckoutSession', () => {
    ...
    test('should handle checkout session creation errors', async () => {
      mockStripe.checkout.sessions.create.mockRejectedValue(new Error('Invalid price ID'))
      ...
      await expect(stripeService.createCheckoutSession(sessionData)).rejects.toThrow(
        expect.objectContaining({
          code: 'INTERNAL_SERVER_ERROR',
          message: 'Failed to create checkout session',
        })
  ...
  describe('constructWebhookEvent', () => {
    ...
    test('should handle invalid webhook signature', async () => {
      ...
      await expect(stripeService.constructWebhookEvent(payload, signature)).rejects.toThrow(
        expect.objectContaining({
          code: 'BAD_REQUEST',
          message: 'Invalid webhook signature',
        })
  ...
  describe('getInvoices', () => {
    test('should retrieve customer invoices', async () => {
      const mockInvoices = [createStripeInvoice(), createStripeInvoice()]
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    test('should handle malformed webhook payloads', async () => {
      ...
      await expect(stripeService.constructWebhookEvent('malformed', 'sig')).rejects.toThrow(
        expect.objectContaining({
          code: 'BAD_REQUEST',
        })
      )
