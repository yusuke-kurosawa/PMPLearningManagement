...
import { I as InternMap } from "./vendor-iUsVqwEv.js";
function ascending$1(a2, b) {
  return a2 == null || b == null ? NaN : a2 < b ? -1 : a2 > b ? 1 : a2 >= b ? 0 : NaN;
}
__name(ascending$1, "ascending$1");
...
function bisector(f) {
  ...
  if (f.length !== 2) {
    ...
    compare2 = /* @__PURE__ */ __name((d, x2) => ascending$1(f(d), x2), "compare2");
...
__name(center$1, "center$1");
function entering() {
  return !this.__axis;
}
__name(entering, "entering");
function axis(orient, scale) {
  var tickArguments = [], tickValues = null, tickFormat2 = null, tickSizeInner = 6, tickSizeOuter = 6, tickPadding = 3, offset = typeof window !== "undefined" && window.devicePixelRatio > 1 ? 0 : 0.5, k2 = 1, x2 = "y", transform = translateX;
  function axis2(context) {
    var values = tickValues == null ? scale.ticks ? scale.ticks.apply(scale, tickArguments) : scale.domain() : tickValues, format2 = tickFormat2 == null ? scale.tickFormat ? scale.tickFormat.apply(scale, tickArguments) : identity$5 : tickFormat2, spacing = Math.max(tickSizeInner, 0) + tickPadding, range2 = scale.range(), range0 = +range2[0] + offset, range1 = +range2[range2.length - 1] + offset, position = (scale.bandwidth ? center$1 : number$2)(scale.copy(), offset), selection2 = context.selection ? context.selection() : context, path2 = selection2.selectAll(".domain").data([null]), tick = selection2.selectAll(".tick").data(values, scale).order(), tickExit = tick.exit(), tickEnter = tick.enter().append("g").attr("class", "tick"), line = tick.select("line"), text = tick.select("text");
    path2 = path2.merge(path2.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor"));
    tick = tick.merge(tickEnter);
    line = line.merge(tickEnter.append("line").attr("stroke", "currentColor").attr(x2 + "2", k2 * tickSizeInner));
    text = text.merge(tickEnter.append("text").attr("fill", "currentColor").attr(x2, k2 * spacing).attr("dy", "0.71em"));
    ...
    tickExit.remove();
    path2.attr("d", tickSizeOuter ? "M" + range0 + "," + k2 * tickSizeOuter + "V" + offset + "H" + range1 + "V" + k2 * tickSizeOuter : "M" + range0 + "," + offset + "H" + range1);
...
var noop$1 = { value: /* @__PURE__ */ __name(() => {
}, "value") };
function dispatch() {
...
__name(parseTypenames$1, "parseTypenames$1");
...
__name(selection_select, "selection_select");
function array$1(x2) {
...
__name(selectorAll, "selectorAll");
...
__name(selection_selectAll, "selection_selectAll");
...
__name(selection_selectChild, "selection_selectChild");
...
__name(selection_selectChildren, "selection_selectChildren");
...
__name(selection_filter, "selection_filter");
function sparse(update) {
  return new Array(update.length);
}
__name(sparse, "sparse");
function selection_enter() {
  return new Selection$1(this._enter || this._groups.map(sparse), this._parents);
}
__name(selection_enter, "selection_enter");
...
EnterNode.prototype = {
  ...
  querySelector: /* @__PURE__ */ __name(function(selector2) {
    return this._parent.querySelector(selector2);
  }, "querySelector"),
  querySelectorAll: /* @__PURE__ */ __name(function(selector2) {
...
__name(selection_data, "selection_data");
...
__name(selection_exit, "selection_exit");
...
__name(selection_join, "selection_join");
...
__name(selection_merge, "selection_merge");
...
__name(selection_order, "selection_order");
...
__name(selection_sort, "selection_sort");
...
__name(selection_call, "selection_call");
function selection_nodes() {
  return Array.from(this);
}
__name(selection_nodes, "selection_nodes");
...
__name(selection_node, "selection_node");
function selection_size() {
  let size = 0;
  for (const node of this) ++size;
  return size;
}
__name(selection_size, "selection_size");
function selection_empty() {
  return !this.node();
}
__name(selection_empty, "selection_empty");
...
__name(selection_each, "selection_each");
function attrRemove$1(name) {
  return function() {
    this.removeAttribute(name);
  };
}
__name(attrRemove$1, "attrRemove$1");
function attrRemoveNS$1(fullname) {
  return function() {
    this.removeAttributeNS(fullname.space, fullname.local);
  };
}
__name(attrRemoveNS$1, "attrRemoveNS$1");
function attrConstant$1(name, value) {
  return function() {
    this.setAttribute(name, value);
  };
}
__name(attrConstant$1, "attrConstant$1");
function attrConstantNS$1(fullname, value) {
  return function() {
    this.setAttributeNS(fullname.space, fullname.local, value);
  };
}
__name(attrConstantNS$1, "attrConstantNS$1");
...
__name(attrFunction$1, "attrFunction$1");
...
__name(attrFunctionNS$1, "attrFunctionNS$1");
...
__name(selection_attr, "selection_attr");
function defaultView(node) {
  return node.ownerDocument && node.ownerDocument.defaultView || node.document && node || node.defaultView;
}
__name(defaultView, "defaultView");
function styleRemove$1(name) {
  return function() {
    this.style.removeProperty(name);
  };
}
__name(styleRemove$1, "styleRemove$1");
function styleConstant$1(name, value, priority) {
  return function() {
    this.style.setProperty(name, value, priority);
  };
}
__name(styleConstant$1, "styleConstant$1");
...
__name(styleFunction$1, "styleFunction$1");
function selection_style(name, value, priority) {
  return arguments.length > 1 ? this.each((value == null ? styleRemove$1 : typeof value === "function" ? styleFunction$1 : styleConstant$1)(name, value, priority == null ? "" : priority)) : styleValue(this.node(), name);
}
__name(selection_style, "selection_style");
...
__name(selection_property, "selection_property");
...
__name(selection_classed, "selection_classed");
function textRemove() {
  this.textContent = "";
}
...
__name(textConstant$1, "textConstant$1");
...
__name(textFunction$1, "textFunction$1");
function selection_text(value) {
  return arguments.length ? this.each(value == null ? textRemove : (typeof value === "function" ? textFunction$1 : textConstant$1)(value)) : this.node().textContent;
}
__name(selection_text, "selection_text");
function htmlRemove() {
  this.innerHTML = "";
}
...
__name(selection_html, "selection_html");
function raise() {
...
__name(selection_raise, "selection_raise");
function lower() {
...
__name(selection_lower, "selection_lower");
...
__name(selection_append, "selection_append");
...
__name(selection_insert, "selection_insert");
function remove() {
...
__name(selection_remove, "selection_remove");
...
__name(selection_clone, "selection_clone");
function selection_datum(value) {
  return arguments.length ? this.property("__data__", value) : this.node().__data__;
}
__name(selection_datum, "selection_datum");
...
__name(selection_on, "selection_on");
...
__name(selection_dispatch, "selection_dispatch");
...
__name(selection_iterator, "selection_iterator");
var root = [null];
function Selection$1(groups, parents) {
  this._groups = groups;
  this._parents = parents;
}
__name(Selection$1, "Selection$1");
function selection() {
...
__name(sourceEvent, "sourceEvent");
...
__name(nopropagation$1, "nopropagation$1");
function noevent$1(event) {
  event.preventDefault();
  event.stopImmediatePropagation();
}
__name(noevent$1, "noevent$1");
...
__name(dragDisable, "dragDisable");
...
const constant$4 = /* @__PURE__ */ __name((x2) => () => x2, "constant$4");
...
__name(defaultFilter$1, "defaultFilter$1");
...
__name(defaultTouchable$1, "defaultTouchable$1");
function drag() {
...
__name(basis$1, "basis$1");
const constant$3 = /* @__PURE__ */ __name((x2) => () => x2, "constant$3");
...
const interpolateRgb = (/* @__PURE__ */ __name(function rgbGamma(y2) {
  var color2 = gamma(y2);
...
__name(tanh, "tanh");
const interpolateZoom = (/* @__PURE__ */ __name(function zoomRho(rho, rho2, rho4) {
...
__name(selection_interrupt, "selection_interrupt");
...
__name(transition_tween, "transition_tween");
...
__name(transition_attr, "transition_attr");
...
__name(transition_attrTween, "transition_attrTween");
...
__name(transition_delay, "transition_delay");
...
__name(transition_duration, "transition_duration");
...
__name(transition_ease, "transition_ease");
...
__name(transition_easeVarying, "transition_easeVarying");
...
__name(transition_filter, "transition_filter");
...
__name(transition_merge, "transition_merge");
function start(name) {
...
__name(transition_on, "transition_on");
...
__name(transition_remove, "transition_remove");
...
__name(transition_select, "transition_select");
...
__name(transition_selectAll, "transition_selectAll");
var Selection = selection.prototype.constructor;
function transition_selection() {
  return new Selection(this._groups, this._parents);
}
__name(transition_selection, "transition_selection");
...
__name(transition_style, "transition_style");
...
__name(transition_styleTween, "transition_styleTween");
...
__name(transition_text, "transition_text");
...
__name(transition_textTween, "transition_textTween");
...
__name(transition_transition, "transition_transition");
...
__name(transition_end, "transition_end");
var id = 0;
...
__name(selection_transition, "selection_transition");
selection.prototype.interrupt = selection_interrupt;
selection.prototype.transition = selection_transition;
const pi$1 = Math.PI, tau$1 = 2 * pi$1, epsilon = 1e-6, tauEpsilon = tau$1 - epsilon;
...
__name(tree_add, "tree_add");
function add(tree2, x2, y2, d) {
  if (isNaN(x2) || isNaN(y2)) return tree2;
  var parent, node = tree2._root, leaf = { data: d }, x0 = tree2._x0, y0 = tree2._y0, x1 = tree2._x1, y1 = tree2._y1, xm, ym, xp, yp, right, bottom2, i, j;
  ...
  while (node.length) {
    ...
    if (parent = node, !(node = node[i = bottom2 << 1 | right])) return parent[i] = leaf, tree2;
  }
...
__name(tree_data, "tree_data");
function tree_extent(_) {
  return arguments.length ? this.cover(+_[0][0], +_[0][1]).cover(+_[1][0], +_[1][1]) : isNaN(this._x0) ? void 0 : [[this._x0, this._y0], [this._x1, this._y1]];
}
__name(tree_extent, "tree_extent");
...
__name(tree_find, "tree_find");
function tree_remove(d) {
  if (isNaN(x2 = +this._x.call(null, d)) || isNaN(y2 = +this._y.call(null, d))) return this;
  var parent, node = this._root, retainer, previous, next, x0 = this._x0, y0 = this._y0, x1 = this._x1, y1 = this._y1, x2, y2, xm, ym, right, bottom2, i, j;
  if (!node) return this;
  if (node.length) while (true) {
    ...
    if (!(parent = node, node = node[i = bottom2 << 1 | right])) return this;
...
__name(tree_remove, "tree_remove");
...
__name(tree_visitAfter, "tree_visitAfter");
function defaultX(d) {
  return d[0];
}
...
function collide(radius) {
  ...
  function force() {
    ...
    for (var k2 = 0; k2 < iterations; ++k2) {
      tree2 = quadtree(nodes, x$2, y$2).visitAfter(prepare);
      for (i = 0; i < n; ++i) {
        node = nodes[i];
...
function link$1(links) {
  var id2 = index, strength = defaultStrength, strengths, distance = constant$2(30), distances, nodes, count2, bias, random, iterations = 1;
  if (links == null) links = [];
  function defaultStrength(link2) {
    return 1 / Math.min(count2[link2.source.index], count2[link2.target.index]);
  }
  __name(defaultStrength, "defaultStrength");
  ...
  __name(initializeStrength, "initializeStrength");
  ...
  __name(initializeDistance, "initializeDistance");
  force.initialize = function(_nodes, _random) {
    nodes = _nodes;
    random = _random;
    initialize();
...
__name(node_iterator, "node_iterator");
...
function transformer$2() {
  var domain = unit, range2 = unit, interpolate2 = interpolate$1, transform, untransform, unknown, clamp = identity$2, piecewise2, output, input;
  function rescale() {
...
const ramp = /* @__PURE__ */ __name((scheme2) => rgbBasis(scheme2[scheme2.length - 1]), "ramp");
...
function shapeArea(x0, y0, y1) {
  var x1 = null, defined = constant$1(true), context = null, curve = curveLinear, output = null, path2 = withPath(area);
...
__name(pointRadial, "pointRadial");
...
__name(_Bump, "Bump");
let Bump = _Bump;
const _BumpRadial = class _BumpRadial {
  constructor(context) {
    this._context = context;
  }
  lineStart() {
...
__name(_BumpRadial, "BumpRadial");
let BumpRadial = _BumpRadial;
...
Transform.prototype = {
  ...
  apply: /* @__PURE__ */ __name(function(point2) {
...
function zoom() {
  ...
  Gesture.prototype = {
    ...
    zoom: /* @__PURE__ */ __name(function(key, transform) {
...
export {
  linkRadial as $,
  curveLinearClosed as A,
  bumpY as B,
  bumpX as C,
  curveBasis as D,
  curveBasisOpen as E,
  curveBasisClosed as F,
  select as G,
  zoom as H,
  simulation as I,
  link$1 as J,
  ...
  shapeStack as i,
  stackOrderNone as j,
  stackOffsetWiggle as k,
  linear as l,
  stackOffsetSilhouette as m,
  stackOffsetNone as n,
  stackOffsetExpand as o,
  point$2 as p,
  shapeArea as q,
  shapeLine as r,
  symbolWye as s,
