const opmFramework = {
  definition: {
    description: "プロジェクト、プログラム、ポートフォリオ、定常業務のマネジメントを調整し、組織の戦略を実行するためのフレームワーク"
  },
  hierarchy: {
    portfolio: {
      id: "portfolio",
      name: "ポートフォリオマネジメント",
      level: 1,
      definition: "戦略目標達成のために実施するプロジェクト、プログラム、サブポートフォリオ、定常業務の集合",
    ...
    program: {
      ...
      name: "プログラムマネジメント",
      level: 2,
      definition: "個別プロジェクトでは実現できないベネフィットを得るために関連する複数プロジェクトやその他の活動を調整して実施すること",
...
const organizationalStructureTypes = {
  functional: {
    id: "functional",
    name: "機能型組織",
...
export {
  opmBenefits as a,
  organizationalStructureTypes as b,
  implementationRoadmap as i,
  opmFramework as o,
  structureComparison as s
};
